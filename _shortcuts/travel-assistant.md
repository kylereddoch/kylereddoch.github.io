...
![{{ item.title }}]({{ page.img | relative_url }}){:style="margin: 0 auto;"}
...
[![Add {{ item.title }} to Shortcut](/assets/img/shortcuts/add-to-siri-btn.png)](https://www.icloud.com/shortcuts/f845f112a9a5432abe438204f26d6313){:style="margin: 0 auto;"}